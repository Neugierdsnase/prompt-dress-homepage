...
type LayoutRouteId = RouteId | "/(blog-article)/blog-posts" | "/(blog-article)/customization" | "/(blog-article)/project-structure" | "/(blog-article)/prompt-engineering-basics" | "/(waves)" | "/(waves)/404" | "/(waves)/blog" | null
