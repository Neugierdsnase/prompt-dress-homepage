...
const Features = [
  ...
  },
  {
    ...
    description: 'With the "shawl" feature (in active development), you can prime the model in multiple steps. Making it easier to get the model to stick to a certain schema or template.',
    image: "images/features/extensible.jpg",
    tags: [{ label: "Coming Soon" }]
  },
  {
    name: "Dynamic values",
    description: 'No more manually searching for words or phrases you need to adjust for the occasion. The "Corsages" feature allows you to dynamically change values in the prompt before feeding it to the model.',
