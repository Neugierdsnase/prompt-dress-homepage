import { c as create_ssr_component, d as escape, g as compute_rest_props, h as spread, j as escape_object, i as is_void, l as compute_slots, v as validate_component, e as each, b as add_attribute } from "./index.js";
...
const css$1 = {
  code: ".content.svelte-1f0frum{display:flex;flex-direction:column;gap:0px;align-items:flex-start}.title.svelte-1f0frum{display:flex;align-items:center;justify-content:space-between;width:100%;font-size:1.2rem;font-family:var(--font--title);font-weight:700}.tags.svelte-1f0frum{display:flex;align-items:center;gap:5px;flex-wrap:wrap}.note.svelte-1f0frum{font-size:0.7rem;color:rgba(var(--color--text-rgb), 0.8)}.text.svelte-1f0frum{margin-top:10px;font-size:0.9rem;text-align:justify}.footer.svelte-1f0frum{margin-top:20px}.blog-post-card .image img{object-fit:cover}.blog-post-card.no-image > .image{display:none}",
  map: null
};
const BlogPostCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Card, "Card").$$render(
    ...
    {
      footer: () => {
        return `<div class="footer svelte-1f0frum" slot="footer">${tags?.length ? `<div class="tags svelte-1f0frum">${each(tags.slice(0, 2), (tag) => {
      ...
      content: () => {
        return `<div class="content svelte-1f0frum" slot="content"><p class="title svelte-1f0frum">${escape(title)}</p>
		${readingTime ? `<div class="note svelte-1f0frum">${escape(readingTime)}</div>` : ``}
		${excerpt ? `<p class="text svelte-1f0frum">${escape(excerpt)}</p>` : ``}</div>`;
      },
      image: () => {
